...
namespace ItaasSolution.Api.Api.Controllers
{
    ...
    public class LogController : ControllerBase
    {
        ...
        /// <param name="request.IdLog">Is the id of an log of the database in that the data must be gotten and converted in format solicited. Example: 1</param>
        /// <param name="request.UrlLog">Is the url with an file of an log in that the content the file must be converted in format solicited. Example: https://s3.amazonaws.com/uux-itaas-static/minha-cdn-logs/input-01.txt</param>
